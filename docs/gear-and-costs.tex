...
\textbf{Recommendation:} start on Oracle's free tier (cost: \$0, and 10 TB ≈ 23 average concurrent viewers at the 1.3 Mbps passthrough rendition; see docs/scaling.tex for what happens past that). If Z0 outgrows it, that's a wonderful problem, and a 20 TB host is one evening's migration.
