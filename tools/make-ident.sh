...
SLUG="${SLUG:-ident}"   # a tagline of pure punctuation must not become "z0-ident-.mp4"
...
drawtext=fontfile='${FONT}':$(z0_text "${TAG}"):fontcolor=${Z0_PAPER}:fontsize=34:x=(w-tw)/2:y=880,\
